...
var wss = new ws.Server({
    port: 3000
}, function () { return console.log("Server started on 3000"); });
...
function chartCall() {
    return __awaiter(this, void 0, void 0, function () {
        var binance, symbolsList, symbols, symbolsListener;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, symbols_1.dailyStat)()];
                case 1:
                    symbolsList = _a.sent();
                    symbols = symbolsList.map(function (obj) { return obj.symbol; });
                    console.log(symbols);
